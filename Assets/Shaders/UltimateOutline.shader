Shader "Outlined/UltimateOutline"
{
	...
	SubShader{
		...
		//Surface shader
		Tags{ "Queue" = "Transparent" "RenderType" = "Transparent" }//"Queue" = "Geometry"}
		CGPROGRAM
		#pragma surface surf NoLighting alpha:fade//Lambert
		...
		void surf(Input IN, inout SurfaceOutput o) {
			fixed4 tex_c = tex2D(_MainTex, IN.uv_MainTex);
			/*if (tex_c.a < 0.6) {
				o.Albedo = _Color.rgb;
			}
			else {
			...
			o.Albedo = lerp(tex_c.rgb, _Color.rgb, (1-tex_c.a) - 0.1);*/
			//fixed4 c = tex2D(_MainTex, IN.uv_MainTex) * _Color;
			o.Albedo = lerp(tex_c.rgba, _Color.rgb, (1 - tex_c.a));
			o.Alpha = _Color.a;
		}
	ENDCG
	}
